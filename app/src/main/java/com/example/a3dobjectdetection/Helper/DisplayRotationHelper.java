...
public class DisplayRotationHelper implements DisplayManager.DisplayListener {
    ...
    /**构造DisplayRotationHelper，但还没有注册侦听器。
    ...
    public DisplayRotationHelper(Context context) {
        ...
        display = windowManager.getDefaultDisplay(); //返回window显示的一个实例
    }
    //注册一个显示侦听器，以接收关于添加、删除或更改显示的通知。
    ...
    /**返回GL表面视口的宽高比，同时考虑到相对于设备摄像机传感器方向的显示旋转。
